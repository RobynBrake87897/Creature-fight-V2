 ...
 * CreatureWorld is the enitial world everything takes place on
 * @author (Robyn Brake) 
 * @version (2)
 */
public class CreatureWorld extends World
{
     ...
     * sets size of creature world, and cell size.
     * 
     * @param none There are no parameters
     * @return objects of class CreatureWorld (Charmander and Pikachu)
     */
    ...
    public void act()
    {
        ...
        if(turnNumber == 0)
        {
            ...
            playerOneName = JOptionPane.showInputDialog(null,"Player One Name", "milly",JOptionPane.QUESTION_MESSAGE);
            ...
            playerTwoName = JOptionPane.showInputDialog(null,"Player One Name", "rock",JOptionPane.QUESTION_MESSAGE);
        ...
        else if(turnNumber == 1)
        {
            ...
            showText("Player one's turn",getHeight()/2, getWidth()/2);
        }
        else//TODO (22): Otherwise...
        {
            ...
            showText("Player two's turn",getHeight()/2, getWidth()/2);
        }
    ...
    /**
     * getTurnNumber returns turnNumber
     * 
     * @param has one parameter called turn
    ...
    /**
     * setTurnNumber initializes turnNumber to turn
     * 
     * @param turn
     * @return nothing is returned
     */
